...
public class AuthController {
    ...
    public ResponseEntity registerUser(@ApiParam(value = "The RegistrationRequest payload")  @RequestBody RegistrationRequest registrationRequest) {
    ...
    @ApiOperation(value = "Receive the reset link request and publish event to send mail containing the password " +
            "reset link")
    public ResponseEntity resetLink(@ApiParam(value = "The PasswordResetLinkRequest payload")  @RequestBody PasswordResetLinkRequest passwordResetLinkRequest) {
    ...
    @ApiOperation(value = "Reset the password after verification and publish an event to send the acknowledgement " +
            "email")
    public ResponseEntity resetPassword(@ApiParam(value = "The PasswordResetRequest payload")  @RequestBody PasswordResetRequest passwordResetRequest) {
