...
public class UserController {
    ...
    public ResponseEntity updateUserPassword(@CurrentUser CustomUserDetails customUserDetails,
                                             @ApiParam(value = "The UpdatePasswordRequest payload")  @RequestBody UpdatePasswordRequest updatePasswordRequest) {
    ...
    public ResponseEntity logoutUser(@CurrentUser CustomUserDetails customUserDetails,
                                     @ApiParam(value = "The LogOutRequest payload")  @RequestBody LogOutRequest logOutRequest) {
